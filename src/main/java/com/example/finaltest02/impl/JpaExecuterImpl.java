...
public class JpaExecuterImpl<T> implements JpaExecutors<T> {
    ...
    public void updateId(String id, String fullname, String birthDate, String position, String address, String department){
        ...
        PreparedStatement preparedStatement = null;
        try {
            preparedStatement = conn.prepareStatement("UPDATE TABLE employee SET fullName = " + "'" + fullname + "'" + "," + "birthDay = " + "'" + birthDate + "'" + "," + "address = " + "'" + address + "'" + "," + "position = " + "'" + position + "," + "department = " + "'" + department + "'" + "'" + " WHERE id = " + id);
        } catch (SQLException e) {
            e.printStackTrace();
        }
        try {
